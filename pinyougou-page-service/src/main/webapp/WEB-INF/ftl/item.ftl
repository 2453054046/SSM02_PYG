...
<head>
    ...
    <script>
        //SKU商品列表
        var skuList=[
            <#list itemList as item>  //获得SKU列表遍历结果
            {
                "id":${item.id?c},//获得的是int类型，需要转字符串类型
                "title":"${item.title!''}",
                "price":${item.price?c},
                "spec": ${item.spec}
            } ,
							...
							<ul class="goods-list unstyled">
								<li>
									<div class="list-wrap">
										...
										<div class="operate">
                                            <a href="www.baidu.com"  class="sui-btn  btn-danger addshopcar" ng-click="addToCart()">加入购物车</a>
										</div>
									</div>
								</li>
								<li>
								...
								<li>
									...
									<div class="list-wrap">
										...
										<div class="operate">
											<a href="#" class="sui-btn btn-bordered" ng-click="addToCatt()">加入购物车</a>
										</div>
									</div>
									<div class="list-wrap">
										<div class="p-img">
