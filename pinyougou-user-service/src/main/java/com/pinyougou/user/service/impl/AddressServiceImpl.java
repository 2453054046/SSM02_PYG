...
public class AddressServiceImpl implements AddressService {
    ...
    public List<TbAreas> findareasList(String id) {
        ...
        List<TbAreas> areas = areasMapper.selectByExample(example);
        return areas;
    }
    @Autowired
     ...
     */
    @Override
    public List<TbCities> findcitiesList(String id) {
        TbCitiesExample example = new TbCitiesExample();
        example.createCriteria().andProvinceidEqualTo(id);
        List<TbCities> cities = citiesMapper.selectByExample(example);
        return cities;
    }
    @Autowired
     ...
     */
    @Override
    public List<TbProvinces> fingProvincesList() {
