						...
						<div id="profile" class="tab-pane  active">
							...
							<form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
								<div class="input-prepend"><span class="add-on loginname"></span>
									<form:input class="span2 input-xfat" id="username" placeholder="邮箱/用户名/手机号" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
								</div>
